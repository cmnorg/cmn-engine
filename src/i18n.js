...
export const STANDALONE = ['faire-un-don', 'don-merci', 'admin-prieres', 'admin', 'mentions-legales', 'confidentialite', 'cookies'];
...
export const UI = {
  ...
  // Page Mur de prière (textes du code)
  'Déposez une requête, priez pour les autres. Une chaîne de prière mondiale, en continu.': { en: 'Post a request, pray for others. A worldwide prayer chain, around the clock.' },
  'Pourquoi déposer une prière ?': { en: 'Why post a prayer?' },
  'Personne ne devrait porter ses fardeaux seul. Dépose ta requête : une communauté de croyants du monde entier priera avec toi, en toute discrétion.': { en: 'No one should carry their burdens alone. Post your request: a community of believers from around the world will pray with you, discreetly.' },
  '« Priez les uns pour les autres, afin que vous soyez guéris. »': { en: '"Pray for one another, that you may be healed."' },
  'Jacques 5:16': { en: 'James 5:16' },
  'requêtes': { en: 'requests' },
  'personnes prient': { en: 'people praying' },
  'Déposer un sujet de prière': { en: 'Post a prayer request' },
  'Prénom (facultatif — laisse vide pour rester anonyme)': { en: 'First name (optional — leave blank to stay anonymous)' },
  'Ton prénom': { en: 'Your first name' },
  'Catégorie': { en: 'Category' },
  'Choisir…': { en: 'Choose…' },
  'Ton sujet de prière': { en: 'Your prayer request' },
  'Écris ta demande de prière…': { en: 'Write your prayer request…' },
  'Déposer ma requête': { en: 'Post my request' },
  "🔒 Tes données restent privées. Les requêtes sont relues avant publication. Évite d'indiquer des informations sensibles (santé détaillée, adresse, téléphone…).": { en: '🔒 Your data stays private. Requests are reviewed before publication. Please avoid sharing sensitive information (detailed health, address, phone…).' },
  'Santé & guérison': { en: 'Health & healing' },
  'Famille': { en: 'Family' },
  'Couple & mariage': { en: 'Couple & marriage' },
  'Enfants': { en: 'Children' },
  'Travail & finances': { en: 'Work & finances' },
  'Études': { en: 'Studies' },
  'Ministère & mission': { en: 'Ministry & mission' },
  'Protection': { en: 'Protection' },
  'Voyage': { en: 'Travel' },
  'Deuil': { en: 'Grief' },
  'Délivrance': { en: 'Deliverance' },
  'Action de grâce': { en: 'Thanksgiving' },
  'Requêtes de la communauté': { en: 'Community requests' },
  'Sois le premier à déposer une prière 🙏': { en: 'Be the first to post a prayer 🙏' },
  'Toutes': { en: 'All' },
  'Anonyme': { en: 'Anonymous' },
  '🙏 Je prie': { en: '🙏 I pray' },
  'Le mur sera bientôt disponible.': { en: 'The wall will be available soon.' },
  'Prières exaucées': { en: 'Answered prayers' },
  'Dieu agit. Voici quelques témoignages de la communauté.': { en: 'God is at work. Here are some testimonies from the community.' },
  'Les premiers témoignages arriveront bientôt 🙌': { en: 'The first testimonies will arrive soon 🙌' },
  'Partager un témoignage': { en: 'Share a testimony' },
  'Prénom (facultatif)': { en: 'First name (optional)' },
  'Ville · Pays (facultatif)': { en: 'City · Country (optional)' },
  'Ex. Cotonou · Bénin': { en: 'e.g. Cotonou · Benin' },
  'Ton témoignage': { en: 'Your testimony' },
  'Raconte ce que Dieu a fait…': { en: 'Tell what God has done…' },
  'Publier mon témoignage': { en: 'Publish my testimony' },
  '🔒 Les témoignages sont relus avant publication.': { en: '🔒 Testimonies are reviewed before publication.' },
  'Écris quelques mots de plus.': { en: 'Write a few more words.' },
  'Merci ! Ta prière sera publiée après relecture. 🙏': { en: 'Thank you! Your prayer will be published after review. 🙏' },
  'Merci, ta prière est publiée ! 🙏': { en: 'Thank you, your prayer is published! 🙏' },
  'Merci ! Ton témoignage sera publié après relecture. 🙌': { en: 'Thank you! Your testimony will be published after review. 🙌' },
  // Bandeau cookies
