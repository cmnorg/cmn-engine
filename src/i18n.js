...
export const UI = {
  ...
  // Page Faire un don (textes du code)
  'Soutenir la mission': { en: 'Support the mission' },
  'Ta générosité transforme des vies, en toute transparence. Don ponctuel ou mensuel, en quelques secondes.': { en: 'Your generosity transforms lives, with full transparency. One-time or monthly gift, in just a few seconds.' },
  '🔒 Paiement 100 % sécurisé': { en: '🔒 100% secure payment' },
  '🧾 Reçu envoyé par e-mail': { en: '🧾 Receipt sent by email' },
  '✋ Don mensuel modifiable ou arrêtable à tout moment': { en: '✋ Monthly gift can be changed or stopped anytime' },
  'Mon soutien': { en: 'My support' },
  'Devise': { en: 'Currency' },
  'Autre montant': { en: 'Other amount' },
  'Mon pays de résidence': { en: 'My country of residence' },
  '— Choisir —': { en: '— Choose —' },
  'Fréquents': { en: 'Frequent' },
  'Tous les pays': { en: 'All countries' },
  'Mes coordonnées': { en: 'My details' },
  'Mme': { en: 'Mrs' },
  'M.': { en: 'Mr' },
  ...
  'Nom *': { en: 'Last name *' },
  'E-mail *': { en: 'Email *' },
  'Confirme ton e-mail *': { en: 'Confirm your email *' },
  'Téléphone *': { en: 'Phone *' },
  "J'autorise CMN à m'envoyer par e-mail les informations importantes concernant mon don.": { en: 'I authorize CMN to email me important information about my gift.' },
  'Mode de paiement': { en: 'Payment method' },
  'Carte ou PayPal': { en: 'Card or PayPal' },
  '(Afrique)': { en: '(Africa)' },
  'Virement bancaire': { en: 'Bank transfer' },
  '💳 Tu choisiras <strong>Carte</strong> ou <strong>PayPal</strong> sur la page de paiement sécurisée.': { en: "💳 You'll choose <strong>Card</strong> or <strong>PayPal</strong> on the secure payment page." },
  'En validant, tu acceptes nos conditions de don et notre': { en: 'By confirming, you accept our donation terms and our' },
  'politique de confidentialité': { en: 'privacy policy' },
  'Je valide mon don': { en: 'Confirm my gift' },
  '🔒 Transaction sécurisée — nous ne stockons jamais tes données bancaires.': { en: '🔒 Secure transaction — we never store your banking details.' },
  'Où vont tes dons': { en: 'Where your gifts go' },
  'Terrain & humanitaire': { en: 'Field & humanitarian' },
  'Formation & missions': { en: 'Training & missions' },
  'Fonctionnement': { en: 'Operations' },
  "Don 100 % sécurisé. Un reçu t'est envoyé par e-mail. Tu peux modifier ou arrêter un don mensuel à tout moment.": { en: '100% secure gift. A receipt is emailed to you. You can change or stop a monthly gift anytime.' },
  'Virement & mobile money': { en: 'Bank transfer & mobile money' },
  'Tu préfères donner autrement ? Voici nos coordonnées.': { en: 'Prefer to give another way? Here are our details.' },
  'Titulaire': { en: 'Account holder' },
  'Banque': { en: 'Bank' },
  'Indique ton nom en référence, puis écris-nous via le': { en: 'Add your name as a reference, then write to us via the' },
  'pour recevoir ton reçu.': { en: 'to receive your receipt.' },
  'formulaire de contact': { en: 'contact form' },
  'Coordonnées bientôt disponibles. En attendant, écris-nous via le': { en: 'Details coming soon. In the meantime, write to us via the' },
  'Une question ?': { en: 'A question?' },
  "Sur ton don, un reçu fiscal ou un autre moyen de paiement, on est là pour t'aider.": { en: "About your gift, a tax receipt or another payment method — we're here to help." },
  ' / mois': { en: ' / month' },
  'Ton don : ': { en: 'Your gift: ' },
  'Choisis un montant': { en: 'Choose an amount' },
  'Choisis un montant.': { en: 'Choose an amount.' },
  'Indique ton prénom et ton nom.': { en: 'Enter your first and last name.' },
  'Indique un e-mail valide.': { en: 'Enter a valid email.' },
  'Les deux e-mails ne correspondent pas.': { en: 'The two emails do not match.' },
  'Indique un téléphone.': { en: 'Enter a phone number.' },
  'Voir les coordonnées': { en: 'See the details' },
  'mobile money': { en: 'mobile money' },
  'virement bancaire': { en: 'bank transfer' },
  'Parfait ! Utilise les coordonnées ci-contre ({m}), indique ton nom en référence, puis écris-nous pour recevoir ton reçu. 🙏': { en: 'Perfect! Use the details on the right ({m}), add your name as a reference, then write to us to receive your receipt. 🙏' },
  ...
  // Page Academy (textes du code)
  'Trouve ton parcours': { en: 'Find your path' },
  'Réponds à 3 questions, on te recommande par où commencer.': { en: "Answer 3 questions and we'll recommend where to start." },
  'Aucun parcours pour le moment.': { en: 'No path available yet.' },
  'cours': { en: 'courses' },
  'Commencer': { en: 'Start' },
  '✨ Recommandé pour toi': { en: '✨ Recommended for you' },
  'Parcours recommandé': { en: 'Recommended path' },
  'Commencer ce parcours': { en: 'Start this path' },
  'terminés': { en: 'completed' },
  'Où en es-tu avec Jésus ?': { en: 'Where are you with Jesus?' },
  'Je ne le connais pas encore / je découvre': { en: "I don't know Him yet / I'm exploring" },
  'Je viens de donner ma vie à Christ': { en: 'I just gave my life to Christ' },
  'Je suis chrétien depuis un moment': { en: "I've been a Christian for a while" },
  'Quel est ton engagement aujourd’hui ?': { en: 'What is your current involvement?' },
  'Je débute, je cherche des bases': { en: "I'm starting out, looking for the basics" },
  'Je sers dans une église': { en: 'I serve in a church' },
  'Je suis responsable, pasteur ou missionnaire': { en: "I'm a leader, pastor or missionary" },
  'Qu’aimerais-tu vivre en priorité ?': { en: 'What would you most like to experience?' },
  'Mieux connaître Jésus et grandir': { en: 'Know Jesus better and grow' },
  'Annoncer l’Évangile autour de moi': { en: 'Share the Gospel around me' },
  'Diriger, former ou partir en mission': { en: 'Lead, train or go on mission' },
  'Bienvenue ! C’est une belle décision de vouloir découvrir Jésus. Voici par où commencer :': { en: "Welcome! It's a wonderful decision to want to discover Jesus. Here's where to start:" },
  'Félicitations pour ce nouveau départ avec Dieu ! Voici les fondations pour bien grandir :': { en: 'Congratulations on this new start with God! Here are the foundations to grow well:' },
  'Voici le parcours qui correspond à là où tu en es aujourd’hui :': { en: 'Here is the path that matches where you are today:' },
  // Bandeau cookies
